...
EXPECTED_EXPORTS = [
    ...
    'gbsharp_get_ram_bank',
    'gbsharp_get_rom_size',
    'gbsharp_get_registers',
    'gbsharp_step',
    'gbsharp_add_breakpoint',
    'gbsharp_remove_breakpoint',
    'gbsharp_clear_breakpoints',
    'gbsharp_set_profiling_enabled',
    'gbsharp_get_profiling_enabled',
    'gbsharp_clear_profile',
    'gbsharp_read_profile',
    'gbsharp_set_rom_usage_enabled',
    'gbsharp_get_rom_usage_enabled',
    'gbsharp_clear_rom_usage',
    'gbsharp_read_rom_usage',
